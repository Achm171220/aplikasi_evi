...
class Auth extends BaseController
{
    ...
    public function loginProcess()
    {
        ...
        $user_role_jabatan = !empty($user['role_jabatan']) ? strtolower($user['role_jabatan']) : null;
        ...
        $sessionData = [
            ...
            'user_role_jabatan' => $user_role_jabatan, // Simpan role_jabatan ke session
    ...
    public function logout()
    {
        ...
        session()->remove('user_role_jabatan');
