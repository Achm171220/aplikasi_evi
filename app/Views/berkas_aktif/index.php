...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if (has_permission('cud_arsip')): // Asumsi hanya yang punya izin CUD bisa import 
        ?>
            <div class="btn-group">
                <a href="<?= site_url('berkas-aktif/new') ?>" class="btn btn-primary">
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= site_url('berkas-aktif/proses-import') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <a href="<?= site_url('berkas-aktif/download-template') ?>" class="btn btn-sm btn-outline-success mb-3">
...
<script>
    $(document).ready(function() {
        $('#table-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?= site_url('berkas-aktif/list') ?>",
                type: "POST"
            },
            columnDefs: [{
                    "targets": 0, // No.
