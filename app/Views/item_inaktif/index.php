...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if (has_permission('cud_arsip_inaktif')): ?>
            <div class="btn-group">
                <a href="<?= site_url('item-inaktif/new') ?>" class="btn btn-sm btn-primary">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form id="filter-form" class="row align-items-end" action="<?= site_url('item-inaktif') ?>" method="get">
                <?php
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= site_url('item-inaktif/proses-import') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <a href="<?= site_url('item-inaktif/download-template') ?>" class="btn btn-sm btn-outline-success mb-3">
    ...
    $(document).ready(function() {
        ...
        function initializeDataTable() {
            ...
            table = $('#table-data').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?= site_url('item-inaktif/list') ?>",
                    type: "POST",
                    data: function(d) {
        ...
        $('#form-peminjaman').on('submit', function(e) {
            ...
            const url = (type === 'item') ? '<?= site_url('item-inaktif/pinjam-item') ?>' : '<?= site_url('berkas-aktif/pinjam-berkas') ?>';
